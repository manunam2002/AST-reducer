CREATE TABLE IF NOT EXISTS t_DX44 (c_LGUf REAL, c_Hlmf3w REAL DEFAULT 749171.692897985, c_ewZ TEXT, c_EwP TEXT DEFAULT 'Fn58MvfLqzQ2DMC4', c_YBA7sBV TEXT CHECK (LENGTH(c_YBA7sBV) > 0));
...
UPDATE  SET;
COMMIT;
DELETE FROM t_DX44 WHERE NOT c_YBA7sBV IS NULL;
