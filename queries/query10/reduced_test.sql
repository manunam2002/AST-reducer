CREATE TABLE IF NOT EXISTS t_N96 (c_HoR4r6 REAL PRIMARY KEY NOT NULL DEFAULT NULL CHECK (c_HoR4r6 >= 0), c_Q8Vrr TEXT NOT NULL, c_8Y8Sjb REAL, c_Ri8lD7pMcg REAL NOT NULL, c_2mQB9Yl INTEGER NOT NULL DEFAULT -820692, UNIQUE (c_Ri8lD7pMcg, c_Q8Vrr, c_2mQB9Yl), FOREIGN KEY (c_8Y8Sjb) REFERENCES t_RyWsl (c_lmSDH));
